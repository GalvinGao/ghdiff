...
`;
  ...
  function buttonTitle(target) {
    return target.kind === 'pull'
      ? m.userscript_open_pull({}, { locale: userscriptLocale() })
      : m.userscript_open_commit({}, { locale: userscriptLocale() });
  }
